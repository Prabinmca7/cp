...
<head>
    ...
    <rn:theme path="/euf/assets/themes/standard" css="site.css, okcs.css, okcs_search.css, intent.css"/>
    <rn:head_content/>
...
<body class="yui-skin-sam yui3-skin-sam" itemscope itemtype="http://schema.org/WebPage" onload="JavaScript:clearRecentAnswers();">
...
<header>
    ...
    <nav>
        ...
        <rn:condition hide_on_pages="home, public_profile, results, answers/list, social/questions/list">
            <div class="rn_SearchBar rn_SearchInput">
                <rn:widget path="okcs/OkcsSimpleSearch" icon_path="" report_page_url="/app/results"/>
                <rn:widget path="okcs/OkcsSuggestions" parent_selector="rn_OkcsSimpleSearch" source_id="OKCSSearch" search_results_url="/app/results"/>
            </div>
        </rn:condition>
    </nav>
</header>
...
<rn:widget path="standard/okcs/OkcsApiTimingOnRefPage"/>
...
function clearRecentAnswers() {
    RightNow.Event.subscribe("evt_logoutResponse", function() { localStorage.setItem("okcsRecentAnswers", "[]"); }, this);
}
</script>
</body>
</html>
