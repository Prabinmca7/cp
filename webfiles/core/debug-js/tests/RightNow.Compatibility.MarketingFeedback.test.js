UnitTest.addSuite({
    ...
    jsFiles: ['/euf/core/debug-js/RightNow.Compatibility.MarketingFeedback.js', '/euf/core/debug-js/RightNow.Text.js'],
    ...
    rightnowMarketingFeedbackTests.add(new Y.Test.Case(
    {
        ...
        //@@@ QA#150422-000040 test for issue with two error links being generated
        testTextField: function() {
            ...
            RightNow.MarketingFeedback.validateTextField(textInputElement, fieldData, textField, errorDisplay);
            Y.Assert.areSame(errorDisplay.className, 'rn_MessageBox rn_ErrorMessage');
            Y.Assert.areSame(errorDisplay.children.length, 1);
            ...
            RightNow.MarketingFeedback.removeErrorsFromForm(formElement, errorDisplay);
            RightNow.MarketingFeedback.validateTextField(textInputElement, fieldData, textField, errorDisplay);
            Y.Assert.areSame(textInputElement.value, "test@test.com");
        },
        ...
        ///@@@ QA#140103-000075 test for the validateFormFields function
        testValidateFormFields: function() {
            var fieldData = {reqd_msg: "reqd_msg",
                             dt_sfx: ['_mon', '_day', '_yr'],
                             dt_lbl: ['mon_lbl', 'day_lbl', 'yr_lbl', 'hr_lbl', 'min_lbl']};
            ...
            var errorDisplay = document.createElement("div");
            var ret = RightNow.MarketingFeedback.validateFormFields(formElement, fieldData, [dateField], errorDisplay);
            Y.Assert.areSame(errorDisplay.className, 'rn_MessageBox rn_ErrorMessage');
        }
    }));
