...
use RightNow\Api as RightNowApi;
 ...
 * @internal
 */
final class InlineImg extends Fattach
{
    ...
    public function guidGet($guid = null){
        ...
        $attachment = RightNowApi::fattach_thread_guid_get($pairData);
        ...
        $attachment = (object) array(
            ...
            'localFileName' => RightNowApi::fattach_full_path($attachment['localfname'], true),
        );
