<?php
require_once CORE_WIDGET_FILES . 'standard/input/FileAttachmentUpload/controller.php';
...
class SocialFileAttachmentUploadTest extends WidgetTestCase {
    public $testingWidget = 'standard/input/SocialFileAttachmentUpload';
