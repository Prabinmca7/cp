UnitTest.addSuite({
    ...
    subInstanceIDs: ['ModerationDateFilter_1', 'ModerationStatusFilter_2', 'ProductCategorySearchFilter_3']
    ...
    moderationFilterDialogTests.add(new Y.Test.Case({
        ...
        setUp: function() {
            ...
            this.cancelBtn = this.findButtonByTextContent('cancel');
            this.applyBtn = this.findButtonByTextContent('apply');
            this.triggerBtn = Y.one(baseSelector + "_TriggerLink");
        },
