...
UnitTest.addSuite({
    ...
    var suite = new Y.Test.Suite({
        name: "standard/discussion/QuestionComments - Editing functionality tests"
    });
    ...
    suite.add(new Y.Test.Case({
        ...
        "Editor appears in place of comment text when edit link is clicked": function() {
            this.wait(function() {
                ...
                Y.Assert.areSame(widget.data.attrs.label_edit_comment, injectedForm.one('label .rn_LabelInput').get('text'));
        ...
        "A comment with a content type of HTML enables editing": function() {
            ...
            this.clickEdit();
            Y.Assert.areSame(widget.data.attrs.label_edit_comment, Y.one('.rn_CommentContent .rn_LabelInput').get('innerHTML'));
