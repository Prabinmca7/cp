...
use RightNow\Libraries\SearchMappers\KFSearchMapper;

RightNow\UnitTest\Helper::loadTestedFile(__FILE__);

class KFSearchMapperTest extends CPTestCase {
    public $testingClass = 'RightNow\Libraries\SearchMappers\KFSearchMapper';
