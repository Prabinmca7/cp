<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="namespace" mode="sidebar-nav">
        ...
        <div class="btn-group view" data-toggle="buttons-radio">
          <button class="btn simple active" title="Show only namespace names"><i class="icon-align-justify"></i></button>
          <button class="btn details" title="Show descriptions and namespace names"><i class="icon-list"></i></button>
        </div>
