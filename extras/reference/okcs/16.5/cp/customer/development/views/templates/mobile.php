                ...
                <div class="rn_NavigationBar">
                    ...
                    <ul class="rn_NavigationMenu">
                        ...
                        <rn:condition config_check="OKCS_ENABLED == true">
                            ...
                            <li><rn:widget path="navigation/NavigationTab" label_tab="#rn:msg:CONTACT_US_LBL#" link="/app/ask" subpages="#rn:msg:EMAIL_US_LBL# > /app/ask, #rn:msg:CALL_US_DIRECTLY_LBL# > javascript:void(0); "/></li>
                        <rn:condition_else>
