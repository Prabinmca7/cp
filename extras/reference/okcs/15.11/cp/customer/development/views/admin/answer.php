...
<html>
    <head>
        ...
        <style type='text/css'>
            ...
            .ok-highlight-sentence {background-color: #D8DFE8;}
            ...
            <div class="mainDiv">
                <div class="headerDiv">
                    ...
                    <? if(($type === 'PDF' && ($CI->agent->browser() === 'Internet Explorer')) || $type !== 'PDF'): ?>
                        ...
                        <a class="leftAnchor" href="javascript:void(0);" onclick="window.prompt('<?= $copyClipboardMsg?>', '<?= $url;?>')"><?= $copyLinkLable;?></a><? if($viewLabel !== null): ?>|<a class="rightAnchor" href="javascript:void(0);" onclick="window.open('<?= $url;?>');"><?= $viewLabel;?></a><? endif; ?>
                        </span>
                    <? elseif($type === 'PDF'): ?>
