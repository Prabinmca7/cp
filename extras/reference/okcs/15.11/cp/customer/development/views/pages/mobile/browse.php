        ...
        <div class="rn_HeroInner">
            <div class="rn_OkcsMobileBrowseHeader">
                ...
                <rn:container source_id="OKCSBrowse">
                    <h2 id="rn_AccordTriggerContentType" class="rn_Collapsed">#rn:msg:CONTENT_TYPE_LBL#<span class="rn_ButtonOff"></span></h2>
                    <h2 id="rn_AccordTriggerProduct" class="rn_Collapsed">#rn:msg:PRODUCT_LBL#<span class="rn_ButtonOff"></span></h2>
                    <h2 id="rn_AccordTriggerCategory" class="rn_Collapsed">#rn:msg:CATEGORY_LBL#<span class="rn_ButtonOff"></span></h2>
