...
<div class="rn_PageContent rn_AccountOverview rn_Container">
    ...
    <div class="rn_Notifs">
        <rn:widget path="okcs/OkcsAnswerNotificationManager" view_type="table" label_no_subscription="No records found." label_caption="<span class='rn_ScreenReaderOnly'>#rn:msg:ANSWER_NOTIFICATIONS_SLASH_SPAN_LBL#</span>"/>
